...
Performed data pre-processing and built a deep learning prediction model.
...
Performed exploratory data analysis and feature engineering and applied feature engineering. Followed up with a deep learning model to predict whether or not the loan will be default using the historical data.de
